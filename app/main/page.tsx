...
const keyOf = (i: MatchQueueItem) => `${i.matchId ?? ''}|${i.matchedUser.id}|${i.message}|${i.matchedAt}`
const mergeQueue = (prev: MatchQueueItem[], incoming: MatchQueueItem[]): MatchQueueItem[] => {
